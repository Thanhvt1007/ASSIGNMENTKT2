...
public class SanPhamDAO extends SoftwareDAO<SanPham, String> {
    ...
    public boolean isSoLuongValid(String soLuong) {
        try {
            Integer.parseInt(soLuong); // Thử chuyển đổi thành số nguyên
            return true; // Nếu chuyển đổi thành công, là kiểu số
        } catch (NumberFormatException e) {
            return false; // Nếu không chuyển đổi được, không phải kiểu số
        }
    }
